...
public class TestServiceImpl implements TestService {
  ...
  @Override
  public void createStatisticHashtag(String id, long accountCount, long blogCount, long postCount) {
  ...
  @Override
  public StatisticHashtag getStatisticHashtag(String id) {
    return statisticHashtagUnit.get(id);
  }
