...
CREATE PUBLICATION publication_blog FOR TABLES IN SCHEMA blog;
CREATE USER replica_blog WITH PASSWORD 'replica_blog' REPLICATION;

GRANT USAGE ON SCHEMA blog TO replica_blog;
GRANT SELECT ON ALL TABLES IN SCHEMA blog TO replica_blog;
GRANT SELECT, USAGE ON ALL SEQUENCES IN SCHEMA blog TO replica_blog;

CREATE SUBSCRIPTION subscription_account_to_blog
...
CREATE SUBSCRIPTION subscription_predefined_to_blog
...
-- CREATE SUBSCRIPTION subscription_blog_to_blog
...
CREATE SUBSCRIPTION subscription_conversation_to_blog
...
CREATE SUBSCRIPTION subscription_customer_to_blog
...
CREATE SUBSCRIPTION subscription_toy_to_blog
...
CREATE SUBSCRIPTION subscription_task_to_blog
...
-- DROP SUBSCRIPTION subscription_account_to_blog;
-- DROP SUBSCRIPTION subscription_predefined_to_blog;
-- DROP SUBSCRIPTION subscription_blog_to_blog;
-- DROP SUBSCRIPTION subscription_conversation_to_blog;
-- DROP SUBSCRIPTION subscription_customer_to_blog;
-- DROP SUBSCRIPTION subscription_toy_to_blog;
-- DROP SUBSCRIPTION subscription_task_to_blog;
