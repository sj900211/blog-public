...
CREATE PUBLICATION publication_toy FOR TABLES IN SCHEMA toy;
CREATE USER replica_toy WITH PASSWORD 'replica_toy' REPLICATION;

GRANT USAGE ON SCHEMA toy TO replica_toy;
GRANT SELECT ON ALL TABLES IN SCHEMA toy TO replica_toy;
GRANT SELECT, USAGE ON ALL SEQUENCES IN SCHEMA toy TO replica_toy;

CREATE SUBSCRIPTION subscription_account_to_toy
...
CREATE SUBSCRIPTION subscription_predefined_to_toy
...
CREATE SUBSCRIPTION subscription_blog_to_toy
...
CREATE SUBSCRIPTION subscription_conversation_to_toy
...
CREATE SUBSCRIPTION subscription_customer_to_toy
...
-- CREATE SUBSCRIPTION subscription_toy_to_toy
...
CREATE SUBSCRIPTION subscription_task_to_toy
...
-- DROP SUBSCRIPTION subscription_account_to_toy;
-- DROP SUBSCRIPTION subscription_predefined_to_toy;
-- DROP SUBSCRIPTION subscription_blog_to_toy;
-- DROP SUBSCRIPTION subscription_conversation_to_toy;
-- DROP SUBSCRIPTION subscription_customer_to_toy;
-- DROP SUBSCRIPTION subscription_toy_to_toy;
-- DROP SUBSCRIPTION subscription_task_to_toy;
